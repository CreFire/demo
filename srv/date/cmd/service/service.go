...
import (
	...
	http "git.tmuyu.com.cn/demo/srv/date/pkg/http"
...
var fs = flag.NewFlagSet("date", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "date")
